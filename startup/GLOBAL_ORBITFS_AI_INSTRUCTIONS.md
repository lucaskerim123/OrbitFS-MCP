...
9. If a required file cannot be located, search live OrbitFS and report the failure rather than guessing.
10. Use OrbitFS-relative paths only. Do not use local Windows paths, Google Drive IDs, directory maps or legacy Project FireStorm paths.
